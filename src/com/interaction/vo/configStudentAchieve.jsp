		    ...
		    <table width="82%" border="0" cellpadding="0" cellspacing="0" class="CContent">
				 <tr>
				  ...
				  <input type="hidden" id="cmid" name="cmid" value=""/>
				    ...
				    <c:forEach items="${sessionScope.elementssaws}" var="elementssaw">
				      <tr>
				        <td class="tableleft" style="text-align:center;">${elementssaw.eename }</td>
				         <td style="text-align:center;">
					        <select id="${elementssaw.eeid }" name="${elementssaw.eename }" style="width:100%;" onblur="selectCheck1();">
