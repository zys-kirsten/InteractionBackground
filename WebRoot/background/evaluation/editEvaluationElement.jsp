...
<font color="#777777" size="5"><strong>请填写${sessionScope.content}因素信息: </strong></font>
<br><br>
<table width="82%" border="0" cellpadding="0" cellspacing="0" class="CContent">
				 <tr>
				  <td>
				  <input type="hidden" name="eeid" value="${sessionScope.ee.eeid }">
				  <input type="hidden" name="evaluationelement.eeid" value="${sessionScope.ee.evaluationelement.eeid }">
				    <table class="table table-bordered table-hover m10" style="margin-left:10px;margin-top:3px;">
				      <tr>
				        ...
				        <td style="text-align:center;">
                          <input type="text" name="eename" value="${sessionScope.ee.eename }">
                        </td>
				      </tr>
				     </table>
				 <tr align="center">
