...
<table class="table table-bordered table-hover definewidth m10">
         ...
         <tr>
           <td>需求主题: <input type="text"></td>
         </tr>
         <tr>
           <td><textarea rows="5" cols="6">课前分组结束以后对研讨课的小组信息进行管理</textarea></td>
         </tr>
         <tr>
           <td><button class="btn btn-primary btn-sm" onclick="">发送</button>
               &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
               <button class="btn btn-primary btn-sm" onclick="">取消</button>
		  </td>
         </tr>
    </table>
