				  ...
				  <input type="hidden" id="cmid" name="cmid" value=""/>
				    <table class="table table-bordered table-hover m10" style="margin-left:10px;margin-top:3px;">
				      <tr>
				        ...
				        <td style="text-align:center;"><input type="text" id="moduleName" name="moduleName" style="width:100%;"/></td>
				      </tr>
				 	</table>
				  </td>
				 </tr>
				  ...
				  <td>
				    <table class="table table-bordered table-hover m10" style="margin-left:10px;margin-top:3px;">
					  <tr>
				        ...
				        <td style="text-align:center;"><input type="text" id="groupNum" name="groupNum" style="width:100%;"/></td>
				      ...
				      <tr>
				        ...
				        <td style="text-align:center;"><input type="text" id="grpMaxNum" name="grpMaxNum" style="width:100%;"/></td>
				        <td class="tableleft" style="text-align:center;">每组最少人数</td>
				        <td style="text-align:center;"><input type="text" id="grpMinNum" name="grpMinNum" style="width:100%;"/></td>
				      </tr>		
				 	</table>
				  </td>
				 </tr>
				  ...
				  <td>
				    <table class="table table-bordered table-hover m10" style="margin-left:10px;margin-top:3px;">
					  ...
					  <tr>
				        ...
				        <td style="text-align:center;"><input type="text" id="score" name="score" style="width:100%;"/></td>
				        <td class="tableleft" style="text-align:center;">学习能力</td>
				        <td style="text-align:center;"><input type="text" id="ability" name="ability" style="width:100%;"/></td>
				      </tr>
				       <tr>
				        <td class="tableleft" style="text-align:center;">活跃程度</td>
				        <td style="text-align:center;"><input type="text" id="activity" name="activity" style="width:100%;"/></td>
				        <td class="tableleft" style="text-align:center;">综合素质</td>
				        <td style="text-align:center;"><input type="text" id="quality" name="quality" style="width:100%;"/></td>
				      </tr>
				       <tr>
				        <td class="tableleft" style="text-align:center;">性别</td>
				        <td style="text-align:center;"><input type="text" id="sex" name="sex" style="width:100%;"/></td>
				      </tr>
				 	</table>
				  </td>
				 </tr>
