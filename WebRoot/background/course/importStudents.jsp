...
<body>
    <br />  
    <form  id="readReportForm" action="${ctxPath }/uploadStuInfo.do?cid=<%=request.getParameter("cid") %>" method="post" enctype="multipart/form-data"  >  
            <label for="file">选课学生名单</label>  
            <input id="file" type="file" name="file" />  
            <p><button type="submit">导入名单</button></p>    
     </form>  
  </body>