...
<table width="82%" border="0" cellpadding="0" cellspacing="0" class="CContent">
				 <tr>
				  <td>
				  <input type="hidden" name="spid" value="${sessionScope.seminarpoint.spid }">
				  <input type="hidden" name="seminar.seId" value="${sessionScope.seminarpoint.seminar.seId }">
				    <table class="table table-bordered table-hover m10" style="margin-left:10px;margin-top:3px;">
				      <tr>
				        ...
				        <td style="text-align:center;">
                          <input type="text" name="content" value="${sessionScope.seminarpoint.content }">
                        </td>
				      </tr>
				     </table>
				 <tr align="center">
