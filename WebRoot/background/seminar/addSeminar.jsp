   ...
   <input type="hidden" id="seId" name="seId" value=""/>
    <table class="table table-bordered table-hover m10" style="margin-left:10px;margin-top:3px;">
      <tr>
        ...
        <td><input type="text" id="seName" name="seName"/><font style="color:red"> *</font></td>
        <td class="tableleft">研讨课主题</td>
        <td><input type="text" id="seTheme" name="seTheme"/><font style="color:red"> *</font></td>
      </tr>
	  <tr>
        <td class="tableleft">人数上限</td>
        <td><input type="text" id="seUp" name="seUp"/></td>
        <td class="tableleft">人数下限</td>
        <td><input type="text" id="seDown" name="seDown"/></td>
      </tr>	
      <tr>
        <td class="tableleft">时间</td>
        <td style="height: 46px; "> <div style="margin:0 auto;">
	             <input type="text" id="seTime" value="选择时间" name="seTime" onClick="return Calendar('seTime');" class="text_time"/>
             </div> 
        </td>
      </tr>	
 	</table>
