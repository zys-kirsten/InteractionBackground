...
<body >
<br>
<form action="${ctxPath }/addTeacherComponent.do"  method="post">
<table class="table table-bordered table-hover definewidth m10">
    ...
    <tr>
	 ...
	 <tbody>     
         <c:forEach items="${sessionScope.functioncomponentVos}" var="fcs">
                    <tr>
                        <td><input type="checkbox" name="choose" value="${fcs.fcid}"/></td>
                        <td>${fcs.fcname}</td>
