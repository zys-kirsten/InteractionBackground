    ...
    <tr>
	 ...
	 <tbody>     
         <tr>
           ...
           <td>小组管理</td>
           <td>张老师</td>
           <td><a href="${ctxPath }/adminBackground/requirement/judgeRequirement.jsp" class="btn btn-primary btn-sm">查看</a></td>
         </tr>
         <tr>
           <td>1002</td>
           <td>学生信息统计</td>
           <td>张老师</td>
           <td><button class="btn btn-primary btn-sm" onclick="">查看</button></td>
         </tr>
         <tr>
           <td>1003</td>
           <td>数据统计</td>
