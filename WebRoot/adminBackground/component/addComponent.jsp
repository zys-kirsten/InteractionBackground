  ...
  <input type="hidden" id="fcid" name="fcid" value=""/>
    <table class="table table-bordered table-hover m10" style="margin-left:10px;margin-top:3px;">
      <tr>
        ...
        <td><input type="text" id="fcname" name="fcname"/><font style="color:red"> *</font></td>
	  ...
	  <tr>
	   <td class="tableleft">构件描述</td>
        <td><input type="text" id="description" name="description"/><font style="color:red"> *</font></td>
      ...
      <tr>
        ...
        <td><input type="text" id="url" name="url"/><font style="color:red"> *</font></td>
      </tr>	
 	</table>
  </td>
 </tr>
