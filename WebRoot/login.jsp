                ...
                <input type="hidden" id="currentUrl" value="${ctxPath }">
                    ...
                    <div class="form-group form-actions">
                        <div class="col-xs-4 col-xs-offset-4 " style="margin: 0 37%;">
                           <!--  <a href="javascript:dologin();" class="btn btn-sm btn-info"><span class="glyphicon glyphicon-off"></span> 登录</a>  -->
                            <a href="javascript:chooseCourse();" class="btn btn-sm btn-info"><span class="glyphicon glyphicon-off"></span> 选择课程</a>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-xs-6 link">
                            <p class="text-center remove-margin"><a href="commonLogin.jsp" ><small>普通登录</small></a>
                            </p>
                        </div>
                        <div class="col-xs-6 link">
